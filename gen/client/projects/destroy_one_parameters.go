...
// WithUUID adds the uuid to the destroy one params
func (o *DestroyOneParams) WithUUID(uuid string) *DestroyOneParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the destroy one params
func (o *DestroyOneParams) SetUUID(uuid string) {
	o.UUID = uuid
}
