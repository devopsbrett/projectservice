...
func (o *DestroyOneNoContent) Error() string {
	return fmt.Sprintf("[DELETE /projects/{uuid}][%d] destroyOneNoContent ", 204)
}
...
func (o *DestroyOneDefault) Error() string {
	return fmt.Sprintf("[DELETE /projects/{uuid}][%d] destroyOne default  %+v", o._statusCode, o.Payload)
}
